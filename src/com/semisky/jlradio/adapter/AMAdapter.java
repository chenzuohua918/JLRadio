...
public class AMAdapter extends CursorAdapter implements OnClickListener {
	private OnAMItemButtonClickListener onAMItemButtonClickListener;

	public interface OnAMItemButtonClickListener {
	...
	public void setOnAMItemButtonClickListener(
			OnAMItemButtonClickListener onAMItemButtonClickListener) {
		this.onAMItemButtonClickListener = onAMItemButtonClickListener;
	}
	...
	public void onClick(View v) {
		Logger.logD("AMAdapter-----------------------collect button click---tag = "
				+ v.getTag());
		if (onAMItemButtonClickListener != null) {
			onAMItemButtonClickListener.onCollectButtonClick(v,
